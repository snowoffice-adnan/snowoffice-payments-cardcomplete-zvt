...
using Snowoffice.Payments.CardCompleteZvt.Zvt.Repositories;
...
public class BmpParser
{
        ...
        ITlvParser tlvParser)
    {
        ...
        var bmpInfos = new BmpInfo[]
        {
            ...
            new BmpInfo { Id = 0x22, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "PAN / EF_ID, 'E' used to indicate a masked numeric digit1. If the card-number contains an odd number of digits, it is padded with an ‘F’.", TryParse = ParsePanData },
            new BmpInfo { Id = 0x23, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Track 2 data, without start and end markers; 'E' used to indicate a masked numeric digit", TryParse = null },
            new BmpInfo { Id = 0x24, DataLength = 3, CalculateDataLength = GetDataLengthLLL, Description = "Track 3 data, without start and end markers; 'E' used to indicate a masked numeric digit", TryParse = null },
            ...
            new BmpInfo { Id = 0x2E, DataLength = 3, CalculateDataLength = GetDataLengthLL, Description = "Synchronous chip data", TryParse = null },
            ...
            new BmpInfo { Id = 0x3C, DataLength = 3, CalculateDataLength = GetDataLengthLLL, Description = "Additional-data/additional-text", TryParse = this.ParseAdditionalText },
            ...
            new BmpInfo { Id = 0x60, DataLength = 3, CalculateDataLength = GetDataLengthLLL, Description = "Individual totals", TryParse = null },
            ...
            new BmpInfo { Id = 0x8B, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Card-name", TryParse = this.ParseCardName },
            new BmpInfo { Id = 0x8C, DataLength = 1, Description = "Card-type-ID of the network operator (see also 8A)", TryParse = null },
            new BmpInfo { Id = 0x9A, DataLength = 3, CalculateDataLength = GetDataLengthLLL, Description = "GeldKarte payments-/ failed-payment record/total record Geldkarte", TryParse = null },
            new BmpInfo { Id = 0xA0, DataLength = 1, Description = "Result-code-AS", TryParse = null },
            new BmpInfo { Id = 0xA7, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Chip-data, EF_ID", TryParse = null },
            new BmpInfo { Id = 0xAA, DataLength = 3, Description = "Date, format YYMMDD (see also 0D)", TryParse = null },
            new BmpInfo { Id = 0xAF, DataLength = 3, CalculateDataLength = GetDataLengthLLL, Description = "EF_Info", TryParse = null },
            ...
            new BmpInfo { Id = 0xD1, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Card offset/PIN-data", TryParse = null },
            ...
            new BmpInfo { Id = 0xE1, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 1", TryParse = null },
            new BmpInfo { Id = 0xE2, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 2", TryParse = null },
            new BmpInfo { Id = 0xE3, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 3", TryParse = null },
            new BmpInfo { Id = 0xE4, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 4", TryParse = null },
            new BmpInfo { Id = 0xE5, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 5", TryParse = null },
            new BmpInfo { Id = 0xE6, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 6", TryParse = null },
            new BmpInfo { Id = 0xE7, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 7", TryParse = null },
            new BmpInfo { Id = 0xE8, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text2 line 8", TryParse = null },
            ...
            new BmpInfo { Id = 0xF1, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 1", TryParse = null },
            new BmpInfo { Id = 0xF2, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 2", TryParse = null },
            new BmpInfo { Id = 0xF3, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 3", TryParse = null },
            new BmpInfo { Id = 0xF4, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 4", TryParse = null },
            new BmpInfo { Id = 0xF5, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 5", TryParse = null },
            new BmpInfo { Id = 0xF6, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 6", TryParse = null },
            new BmpInfo { Id = 0xF7, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 7", TryParse = null },
            new BmpInfo { Id = 0xF8, DataLength = 2, CalculateDataLength = GetDataLengthLL, Description = "Text1 line 8", TryParse = null },
    ...
    /// <returns></returns>
    public static int GetDataLengthLL(byte[] data)
    {
        if (data.Length != 2)
        {
            return 0;
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    public static int GetDataLengthLLL(byte[] data)
    {
        if (data.Length != 3)
        {
            return 0;
